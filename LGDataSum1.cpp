...
void LGDataSummary::ReadEv(string readStr){
    ...
    // TEST EVENTS            
                ...
                for(int evCount = 0; evCount < nEntries; evCount++){
                    ...
                    //added to get currents and BV vals per event
                    auto evCurrents = ev->Gethvc();
                    auto evBVs = ev->Gethv();
                        // add to currents and BV vectors for file
    ...
    // HLED EVENTS            
                ...
                // added to print out max current and avg BV vals for each file
...
// TTree *tree = 0;
// IEvent *ev;
// void LGDataSummary::SetBranches(IEvent *evD){	
//     tree->SetBranchAddress("Events", &ev);
// }
//
