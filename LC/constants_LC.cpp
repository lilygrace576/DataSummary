...
std::string dataDir = "/data/TrinityLabComputer/TrinityDemonstrator/DataAnalysis/";
std::string outDir = "/data/TrinityLabComputer/TrinityDemonstrator/DataAnalysis/DataSummary/Output/";
const int maxCh = 256;
